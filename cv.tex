...
\cventry{2016--current}{Systems Consultant}{International Livestock Research Institute}{}{}{Technical management of institutional repository and research-computing infrastructure\newline{}
  \begin{itemize}
  \item Maintain and deploy source code customizations of the \href{https://cgspace.cgiar.org}{CGSpace} application
  \item Manage Linux server and software stack for development and production instances of the CGSpace application
  \item Communicate with content submitters and editors about quality and scope of metadata in the repository
  \item Create tools to perform automated validation and correction of metadata in the repository
  \item Inform stakeholders on developments and upcoming features in the upstream DSpace open-source software project
  \item Work with partners on integration with the repository and advise on best practices
  \item Support distributed research-computing infrastructure used for bioinformatics applications
  \item Automate role-based infrastructure deployment and configuration management using Ansible
  \item Advise ICT manager on strategic decisions about platform direction
  \end{itemize}}
...
\cvitem{Intermediate}{MySQL, PostgreSQL, PHP, Apache Tomcat, gerrit, TLS, Jinja2, Python, Solr}
...
\cvitemwithcomment{Bulgarian}{Intermediate}{Written and spoken}
\cvitemwithcomment{Arabic}{Beginner}{Written and spoken}
...
\cvitem{Reading}{Books about history, science, and the history of religion}
